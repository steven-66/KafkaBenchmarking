...
public class AssignSeekConsumer {
    ...
    public static void main(String[] args) {
        String server = "127.0.0.1:9091";
        String topic = "synthetic-data";
        long offset = 0;
        int partitionNum = 0;
        int numOfMessages = 1048576;
    ...
    private void fetchMessages(KafkaConsumer<String, String> consumer, int numOfMessages) {
        ...
        System.out.printf("Throughput for consumer is: " + (double)7000/(endTime-startTime) + " MB/s\n");
        System.out.printf("latency for consumer is: " + (endTime-startTime)/numReq + " ms");
    }
    ...
    private Properties consumerProps(String bootstrapServer) {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "kafka-bench");
